...
from modules.Nebesniy_svet.scr.Lightstar import xml_to_dict_lightstar
import config
...
def send_data_batch_price(prices_data):
    ...
    base_url = "https://api.partner.market.yandex.ru/businesses/78527993/offer-prices/updates"
